...
namespace Word2VecConsoleApp
{
    class Program
    {
        ...
        public static BestWord[] TestModel(string text, string model)
        {
                var distance = new Distance(AppDomain.CurrentDomain.BaseDirectory + model);
